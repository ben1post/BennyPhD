...
app = dash.Dash(__name__, assets_external_script='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/config/TeX-MML-AM_CHTML.js')
...
app.layout = html.Div([
    html.H1('Walmart Store A Openings'),
...
@app.callback(
    ...
    [dash.dependencies.Input('ODE', 'hoverData')])

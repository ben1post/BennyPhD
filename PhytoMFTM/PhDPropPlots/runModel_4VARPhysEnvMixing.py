...
def setupinitcond(pfn,zn):
    ...
    Z0 = 0.0 / zn  # Initial Zooplankton concentration (mmol*m^-3)
    D0 = 0.0  # Initial Detritus concentration (mmol*m^-3)
    P0 = 0.0 / pfn  # Initial Phytoplankton concentration (mmol*m^-3)
...
out5P2Z = callmodelrun(5,2,'constantKappa')

out5P2Z_2 = callmodelrun(5,2,'stochasticKappa')

out5P2Z_3 = callmodelrun(5,2,'constantMLD')

out5P2Z_4 = callmodelrun(5,2,'MLD_and_stochastic')
...
%EST: The abstract needs to be amended to make a better case for presenting your study to a general audience and to attract the interest of the reader to your entire proposal. %% Consider that each sentence should build up information starting from general to specific and although it is brief it should not be ambiguous.
...
%dont need to talk about trait-based stuff here, if I ain't using it
The field of phytoplankton modeling has seen great advances in the last 20 years, in particular the “trait-based” approach 
promises  % rephrase here, promises is the wrong word: advancements
...
(i.e. their traits) % bee boo bee boo ... wrong def of trait!
